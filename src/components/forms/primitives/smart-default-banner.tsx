  ...
  return (
    <div className={cn("rounded-lg border border-dashed border-warning/60 bg-warning/10 p-3", className)}>
      <div className="flex items-start gap-2">
        ...
        <div>
          <p className="text-xs text-warning-foreground/80">{t("continueFromYesterday")}</p>
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        <button
          type="button"
          onClick={onContinue}
          className="h-11 rounded-md bg-primary text-primary-foreground text-sm font-semibold"
        >
          {t("yesContinue")}
        </button>
        <button
          type="button"
          onClick={onChange}
          className="h-11 rounded-md bg-secondary text-foreground text-sm font-semibold"
        >
          {t("change")}
        </button>
      </div>
